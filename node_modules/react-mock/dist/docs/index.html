...
<head>
	...
	<title>react-mock | react-mock</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">react-mock</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-class">
			<a href="classes/serverclass.html" class="tsd-kind-icon">Server<wbr>Class</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/uidclass.html" class="tsd-kind-icon">Uid<wbr>Class</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/idatagenerator.html" class="tsd-kind-icon">IData<wbr>Generator</a>
		</li>
		<li class=" tsd-kind-variable">
			<a href="globals.html#faker" class="tsd-kind-icon">Faker</a>
		</li>
		<li class=" tsd-kind-variable">
			<a href="globals.html#fakergenerator" class="tsd-kind-icon">Faker<wbr>Generator</a>
		</li>
		<li class=" tsd-kind-variable">
		...
		<li class=" tsd-kind-function">
			<a href="globals.html#createdeleteroute" class="tsd-kind-icon">create<wbr>Delete<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#creategetroute" class="tsd-kind-icon">create<wbr>Get<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#createheadroute" class="tsd-kind-icon">create<wbr>Head<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#createoptionsroute" class="tsd-kind-icon">create<wbr>Options<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#createpatchroute" class="tsd-kind-icon">create<wbr>Patch<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#createpostroute" class="tsd-kind-icon">create<wbr>Post<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#createputroute" class="tsd-kind-icon">create<wbr>Put<wbr>Route</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#implementsidg" class="tsd-kind-icon">implementsIDG</a>
		</li>
	</ul>
</nav>
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="react-mock">React Mock</h1>
			<p><a href="https://github.com/prettier/prettier"><img src="https://img.shields.io/badge/styled_with-prettier-ff69b4.svg" alt="styled with prettier"></a>
				<a href="https://travis-ci.org/nshimiye/react-mock"><img src="https://travis-ci.org/nshimiye/react-mock.svg?branch=master" alt="Build Status"></a>
				<a href="https://coveralls.io/github/nshimiye/react-mock?branch=master"><img src="https://coveralls.io/repos/github/nshimiye/react-mock/badge.svg?branch=master" alt="Coverage Status"></a>
				<a href="https://david-dm.org/nshimiye/react-mock?type=dev"><img src="https://david-dm.org/nshimiye/react-mock/dev-status.svg" alt="Dev Dependencies"></a>
				<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/nshimiye/react-mock.svg" alt="Greenkeeper badge"></a>
			<a href="https://paypal.me/nshimiyetech"><img src="https://img.shields.io/badge/donate-paypal-blue.svg" alt="Donate"></a></p>
			<p>Mocking api calls from React Applications, using Pretenderjs and Fakerjs.</p>
			<h1 id="simple-example-usage">Simple Example usage</h1>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { Server, Faker, uid } <span class="hljs-keyword">from</span> <span class="hljs-string">'react-mock'</span>
<span class="hljs-keyword">const</span> endPoint = <span class="hljs-string">'/api/v1/todos'</span>

<span class="hljs-keyword">const</span> todoSchema = {
  <span class="hljs-attr">author</span>: Faker.internet.email(),
  <span class="hljs-attr">content</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> Faker.lorem.sentence(),
  <span class="hljs-attr">createdAt</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> Faker.date.past()
}

<span class="hljs-keyword">const</span> requestHandler = <span class="hljs-function">(<span class="hljs-params">request, generator</span>) =&gt;</span> {
  <span class="hljs-keyword">const</span> todoList = generator.next(<span class="hljs-number">10</span>, todoSchema);
  <span class="hljs-keyword">return</span> [<span class="hljs-number">200</span>, { <span class="hljs-string">'Content-Type'</span>: <span class="hljs-string">'application/json'</span> }, <span class="hljs-built_in">JSON</span>.stringify(todoList)];
}

Server.mockGet(endPoint, requestHandler)
Server.on() <span class="hljs-comment">// to start mocking /api/v1/todos API</span>
</code></pre>
			<pre><code class="lang-javascript">axios.get(<span class="hljs-string">'/api/v1/todos'</span>).then(<span class="hljs-function">(<span class="hljs-params">{ data }</span>) =&gt;</span> {
  <span class="hljs-comment">// data is an array of 10 todo objects</span>
})
</code></pre>
			<h1 id="real-use-case">Real use case</h1>
			<ul>
				<li>Suppose you want to simulate the fetching of 10 guides<ul>
						<li>You know the <strong>API Endpoint</strong></li>
						<li>You know the <strong>Format</strong> of each guide object </li>
						<li>You know the <strong>Format</strong> of the Error response </li>
					</ul>
				</li>
			</ul>
			<pre><code class="lang-javascript"><span class="hljs-comment">// &lt;app-root&gt;/src/mock-server</span>

<span class="hljs-keyword">import</span> { Server, Faker, uid } <span class="hljs-keyword">from</span> <span class="hljs-string">'react-mock'</span>

<span class="hljs-keyword">const</span> apiRoute = <span class="hljs-string">'/api/v1/guides'</span>
<span class="hljs-keyword">const</span> requestHandler = <span class="hljs-function">(<span class="hljs-params">request, generator</span>) =&gt;</span> {
  <span class="hljs-keyword">const</span> guides = generator.next(<span class="hljs-number">10</span>); <span class="hljs-comment">// @returns { &lt;id1&gt;: schema1, &lt;id2&gt;: schema2 }</span>
  <span class="hljs-comment">// const error = generator.error();</span>
  <span class="hljs-keyword">return</span> [<span class="hljs-number">200</span>, { <span class="hljs-string">'Content-Type'</span>: <span class="hljs-string">'application/json'</span> }, <span class="hljs-built_in">JSON</span>.stringify(guides)];
}

<span class="hljs-keyword">const</span> schema = {
  <span class="hljs-attr">description</span>: Faker.lorem.sentence(),
  <span class="hljs-attr">createdAt</span>: Faker.date.past(),
  <span class="hljs-attr">favoredCount</span>: Faker.random.number(),
  <span class="hljs-attr">isPublic</span>: random.boolean(),
  <span class="hljs-attr">author</span>: {
    <span class="hljs-attr">id</span>: uid.next(),
    <span class="hljs-attr">name</span>: Faker.name.findName(),
    <span class="hljs-attr">picture</span>: Faker.internet.avatar()
  }
};

<span class="hljs-keyword">const</span> errorFormat = {
  <span class="hljs-attr">message</span>: Faker.lorem.sentence()
}

Server.mockGet(apiRoute, requestHandler, schema, errorFormat)

Server.on() <span class="hljs-comment">// @returns Promise that resolves with null or rejects with Error</span>
<span class="hljs-comment">// Server.off()</span>
</code></pre>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/datagenerator.html" class="tsd-kind-icon">Data<wbr>Generator</a></li>
							<li class="tsd-kind-class"><a href="classes/serverclass.html" class="tsd-kind-icon">Server<wbr>Class</a></li>
							<li class="tsd-kind-class"><a href="classes/uidclass.html" class="tsd-kind-icon">Uid<wbr>Class</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/idatagenerator.html" class="tsd-kind-icon">IData<wbr>Generator</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Variables</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable"><a href="globals.html#faker" class="tsd-kind-icon">Faker</a></li>
							<li class="tsd-kind-variable"><a href="globals.html#fakergenerator" class="tsd-kind-icon">Faker<wbr>Generator</a></li>
							<li class="tsd-kind-variable"><a href="globals.html#server" class="tsd-kind-icon">Server</a></li>
							<li class="tsd-kind-variable"><a href="globals.html#uid" class="tsd-kind-icon">uid</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function"><a href="globals.html#createdeleteroute" class="tsd-kind-icon">create<wbr>Delete<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#creategetroute" class="tsd-kind-icon">create<wbr>Get<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#createheadroute" class="tsd-kind-icon">create<wbr>Head<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#createoptionsroute" class="tsd-kind-icon">create<wbr>Options<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#createpatchroute" class="tsd-kind-icon">create<wbr>Patch<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#createpostroute" class="tsd-kind-icon">create<wbr>Post<wbr>Route</a></li>
							<li class="tsd-kind-function"><a href="globals.html#createputroute" class="tsd-kind-icon">create<wbr>Put<wbr>Route</a></li>
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#implementsidg" class="tsd-kind-icon">implementsIDG</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="faker" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> Faker</h3>
				<div class="tsd-signature tsd-kind-icon">Faker<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">FakerStatic</span><span class="tsd-signature-symbol"> =&nbsp;faker</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/index.ts#L109">index.ts:109</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="fakergenerator" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> Faker<wbr>Generator</h3>
				<div class="tsd-signature tsd-kind-icon">Faker<wbr>Generator<span class="tsd-signature-symbol">:</span> <a href="classes/datagenerator.html" class="tsd-signature-type">DataGenerator</a><span class="tsd-signature-symbol"> =&nbsp;new DataGeneratorClass()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/index.ts#L112">index.ts:112</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="server" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> Server</h3>
				<div class="tsd-signature tsd-kind-icon">Server<span class="tsd-signature-symbol">:</span> <a href="classes/serverclass.html" class="tsd-signature-type">ServerClass</a><span class="tsd-signature-symbol"> =&nbsp;new ServerClass()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/index.ts#L113">index.ts:113</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable">
				...
				<div class="tsd-signature tsd-kind-icon">uid<span class="tsd-signature-symbol">:</span> <a href="classes/uidclass.html" class="tsd-signature-type">UidClass</a><span class="tsd-signature-symbol"> =&nbsp;new UidClass()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/uid.ts#L12">uid.ts:12</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createdeleteroute" class="tsd-anchor"></a>
				<h3>create<wbr>Delete<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Delete<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">deleteRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/delete.ts#L10">methods/delete.ts:10</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>dg: <a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a></h5>
							</li>
							<li>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal">
											<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>req<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Object</span>, generator<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ResponseData</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ResponseData</span><span class="tsd-signature-symbol">&gt;</span></li>
										</ul>
										<ul class="tsd-descriptions">
											<li class="tsd-description">
												<h4 class="tsd-parameters-title">Parameters</h4>
												<ul class="tsd-parameters">
													<li>
														<h5>req: <span class="tsd-signature-type">Object</span></h5>
													</li>
													<li>
														<h5>generator: <a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a></h5>
													</li>
												</ul>
												<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">ResponseData</span>
													<span class="tsd-signature-symbol"> | </span>
													<span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ResponseData</span><span class="tsd-signature-symbol">&gt;</span>
												</h4>
											</li>
										</ul>
									</li>
							...
							<li>
								<h5><span class="tsd-flag ts-flagRest">Rest</span> <span class="tsd-signature-symbol">...</span>others: <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">deleteRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="creategetroute" class="tsd-anchor"></a>
				<h3>create<wbr>Get<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Get<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">getRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/get.ts#L10">methods/get.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">getRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createheadroute" class="tsd-anchor"></a>
				<h3>create<wbr>Head<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Head<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">headRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/head.ts#L10">methods/head.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">headRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createoptionsroute" class="tsd-anchor"></a>
				<h3>create<wbr>Options<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Options<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">optionsRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/options.ts#L10">methods/options.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">optionsRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createpatchroute" class="tsd-anchor"></a>
				<h3>create<wbr>Patch<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Patch<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">putRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/patch.ts#L10">methods/patch.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">putRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createpostroute" class="tsd-anchor"></a>
				<h3>create<wbr>Post<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Post<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">postRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/post.ts#L10">methods/post.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">postRouteMap</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="createputroute" class="tsd-anchor"></a>
				<h3>create<wbr>Put<wbr>Route</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Put<wbr>Route<span class="tsd-signature-symbol">(</span>dg<span class="tsd-signature-symbol">: </span><a href="interfaces/idatagenerator.html" class="tsd-signature-type">IDataGenerator</a>, endPoint<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, handler<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, <span class="tsd-signature-symbol">...</span>others<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">putRouteMap</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/methods/put.ts#L10">methods/put.ts:10</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="implementsidg" class="tsd-anchor"></a>
				<h3>implementsIDG</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">implementsIDG<span class="tsd-signature-symbol">(</span>instance<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/nshimiye/react-mock/blob/6f81335/src/react-mock/index.ts#L22">index.ts:22</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>type guard
								check to see if passed in object implements IDataGenerator</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
